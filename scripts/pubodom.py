...
odom_pub = rospy.Publisher("odom", Odometry, queue_size=50)  #mes_odomというトピック名 odmetry 型のメッセージ　これは計測輪だけでつかうためにトピック名をodomにした
...
while not rospy.is_shutdown():
    ...
    if len(mbed_odom) == 6:
        ...
        odom_broadcaster.sendTransform((mbed_odom[0],mbed_odom[1],0.0), odom_quat, current_time,"base_link","mea_odom")
